class SuccessIcon extends StatusIcon {
    render() {
        return super.render(<svg viewBox="0 0 50 50" stroke="#000" stroke-linecap="round" stroke-linejoin="round" fill={this.props.color} fill-rule="evenodd">
