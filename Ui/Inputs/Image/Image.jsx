class ImageInput extends BaseInput {
    ...
    render() {
        return <InputContainer label={this.schema.label} id={this.id} className={[this.props.className, 'image-input']} ref="container">
            <div className="input-wrapper" ref="input">
                <input type="file" name={this.schema.name} onChange={this.change.bind(this)} id={this.id} accept="image/png, image/jpeg" ref="file" />
