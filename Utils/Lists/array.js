...
/**
 * Joins an array of strings as a URL.
 * @returns {string}
 */
Object.defineProperty(Array.prototype, 'joinAsUrl', {
    enumerable: false,
    value: function () {
        let url = '';
...
/**
 * Joins an array of strings as a class attribute value.
 * @returns {string}
 */
Object.defineProperty(Array.prototype, 'toClassName', {
    enumerable: false,
    value: function (extras) {
        let className = this.filterEmpty().join(' ').trim();
        if (typeof extras === 'string') { className += ' ' + extras.trim(); }
        else if (Array.isArray(extras)) { className += ' ' + extras.toClassName(); }
        return className;
    }
});
 ...
 * @returns {Array}
 */
Object.defineProperty(Array.prototype, 'getSearchable', {
    enumerable: false,
    value: function () {
 ...
 * @returns {object}
 */
Object.defineProperty(Array.prototype, 'findByQuery', {
    enumerable: false,
